...
public class AndroidPlatformStrategy extends PlatformStrategy {
	/** TextViewVariable. */
	private WeakReference<TextView> mTextViewOutput;
	...
	public AndroidPlatformStrategy(Object output, final Object activityParam) {
		 ...
		 */
		mTextViewOutput = new WeakReference<TextView>((TextView) output);
	...
	public void print(final String outputString) {
		...
		Runnable r = new Runnable() {
			...
			@Override
			public void run() {
				mTextViewOutput.get().append(outputString + '\n');
			}
		};

		this.mActivity.get().runOnUiThread(r);
	}
