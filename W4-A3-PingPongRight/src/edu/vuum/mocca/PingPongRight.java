...
public class PingPongRight {
	...
	public static class PlayPingPongThread extends Thread {
		 ...
		 */
		// TODO - You fill in here.
		SimpleSemaphore[] semaphores = new SimpleSemaphore[2];
		...
		private void acquire() {
			// TODO fill in here
			this.semaphores[FIRST_SEMA].acquireUninterruptibly();
		}
		...
		private void release() {
			// TODO fill in here
			this.semaphores[SECOND_SEMA].release();
		}
	}
	...
	public static void main(String[] args) throws InterruptedException {
		process("Ready...Set...Go!", "Ping!  ", " Pong! ", "Done!", 10);
	}
}
